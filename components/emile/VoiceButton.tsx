...
// V2 (sept 2026) - Activer la dictée vocale
// Composant conservé pour la V2 d'Émile. Désactivé par défaut.
// Branchement : passer disabled={false} à <VoiceButton /> dans EmileInput
// pour réactiver le tap (transcription éditable) et le maintien (vocal direct).
// L'API /api/whisper reste opérationnelle.
...
interface VoiceButtonProps {
  ...
  /** V2 — défaut true (désactivé). Passer false pour réactiver. */
  disabled?: boolean;
}
  ...
  const buttonColorCls = swipeArmed
    ...
    : transcribing
      ...
      : recording
        ...
        : "bg-transparent text-[#6b7280] hover:bg-[var(--primary-bg)] hover:text-[var(--primary)]";
    ...
    <div className="relative flex flex-col items-start">
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          title={
            disabled
              ? "Dictée vocale (disponible en V2)"
              : "Tap = dicter · Maintien = vocal direct"
          }
